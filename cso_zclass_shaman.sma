...
// Zombie Attributes
new const zclass_name[] = "Shaman Zombie" // name
new const zclass_info[] = "\y[ Alarm \r[E] \y]" // description
new const zclass_model[] = "Shaman" // model
new const zclass_clawmodel[] = "zombie_plague/v_shaman.mdl" // claw model
new KNOCKBOMB_GHOST[] = "tx/bombjump/bomb_shamancso.mdl"
new const zclass_ring_sprite[] = "sprites/shockwave.spr" // ring sprite
new const zclass_screamsounds[][] = { "tox_cso/zm_skills/shaman-scream.wav" } // scream sound

// Scream ring color		R	G	B
new zclass_ring_colors[3] = {	255,	0,	0	}

const zclass_health = 10000 // health
...
new const infect_ghost_sound[] = "zombie_plague/shaman/infect_01.wav" 
new const pain_ghost_sound[] = "zombie_plague/shaman/pain_031.wav" 
new const pain_ghost_sound2[] = "zombie_plague/shaman/pain_021.wav"
new const death_ghost_sound[] = "zombie_plague/shaman/die_03.wav" 
...
public plugin_init()
{
	...
	cvar_reloadtime = register_cvar("zp_siren_scream_reload_time", "10.0")
...
public handle_gun(id)
{
	...
	if(weap == CSW_FLASHBANG && zp_get_user_zombie_class(id) == g_iSirenZID && zp_get_user_zombie(id))
	{
	entity_set_string(id, EV_SZ_viewmodel, KNOCKBOMB_GHOST)
	}
	else if(weap == CSW_SMOKEGRENADE && zp_get_user_zombie_class(id) == g_iSirenZID && zp_get_user_zombie(id))
	{
	entity_set_string(id, EV_SZ_viewmodel, KNOCKBOMB_GHOST)
	}
...
public fw_EmitSound(id, channel, const sample[], Float:volume, Float:attn, flags, pitch)
{
	...
	if(zp_get_user_zombie(id) && zp_get_user_zombie_class(id) == g_iSirenZID && !zp_get_user_nemesis(id))
	{
